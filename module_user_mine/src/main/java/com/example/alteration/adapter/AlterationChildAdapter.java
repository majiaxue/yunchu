...
public class AlterationChildAdapter extends MyRecyclerAdapter<AlterationBean.RBean.ItemlistBean> {

    public AlterationChildAdapter(Context context, List<AlterationBean.RBean.ItemlistBean> mList, int mLayoutId) {
