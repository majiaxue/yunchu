...
//                });
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Map build = MapUtil.getInstance().addParms("orderSn", orderDetailBean.getItems().get(0).getOrderSn()).build();
                        ...
                        RetrofitUtil.getInstance().toSubscribe(data, new OnMyCallBack(new OnDataListener() {
                            @Override
                            public void onSuccess(String result, String msg) {
                                LogUtil.e("删除onSuccess---------->" + result);
                                if (orderDetailBean.getItems().get(0).getOrderSn().equals(result)) {
                                    if (getView() != null) {
