...
public class ShoppingCartFragment extends BaseFragment<ShoppingCartView, ShoppingCartPresenter> implements ShoppingCartView {
    ...
    public void initData() {
        ...
        shoppingCartCheckAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenter.checkAllParent(isCheckAllParent);//false
            }
        });
    ...
    public void initClick() {
        ...
        mToBuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ARouter.getInstance().build("/module_user_store/typeDetail").withString("search", "").navigation();
            }
        });
    }
    ...
    @Override
    public void loadCartRv(CartChildRecAdapter adapter) {
...
//        presenter.click();
    ...
    public void totalPrice(double price) {
        shoppingCartTotal.setText("" + new DecimalFormat("0.00").format(price));
    }
