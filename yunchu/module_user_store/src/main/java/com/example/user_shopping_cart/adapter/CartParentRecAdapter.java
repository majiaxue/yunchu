 ...
 * Describe:
 */
public class CartParentRecAdapter extends MyRecyclerAdapter<CartBean> {

    public CartParentRecAdapter(Context context, List<CartBean> mList, int mLayoutId) {
...
//    }
//
//    public CartParentRecAdapter(Context context, List<CartBean> mList, int mLayoutId, OnSelectViewListener listener, OnCountChangeListener changeListener) {
//        super(context, mList, mLayoutId);
//        parentList = mList;
