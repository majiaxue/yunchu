...
public class MineFragment extends BaseFragment<MineView, MinePresenter> implements MineView {
    ...
    public void initClick() {
        ...
        //点击开通
        userMineOpenedManager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (TextUtils.isEmpty(SPUtil.getToken())) {
                    ARouter.getInstance().build("/mine/login").navigation();
        ...
        userMineMyService.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "18970207052"));
...
//                getActivity().startActivity(intent);
        ...
        userMineMyPlan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(SPUtil.getToken())) {
                    ...
                    ARouter.getInstance().build("/mine/plan").navigation();
                }
            }
        });
    ...
    public void loadUserinfo(UserInfoBean userInfoBean) {
        userMineMyIntervigationCount.setText(userInfoBean.getBlance() + "");
        LogUtil.e("++++++++"+userInfoBean.getLevel());
        if ("1".equals(userInfoBean.getLevelId())) {
            mineLevel.setText("普通会员");
            lijikaitong.setText("普通会员");
        } else if ("2".equals(userInfoBean.getLevelId())) {
            lijikaitong.setText("V1会员");
            mineLevel.setText("V1会员");
        } else if ("3".equals(userInfoBean.getLevelId())) {
            lijikaitong.setText("V2会员");
            mineLevel.setText("V2会员");
        } else if ("4".equals(userInfoBean.getLevelId())) {
            lijikaitong.setText("V3会员");
            mineLevel.setText("V3会员");
        } else {
            mineLevel.setText("立即开通");
        }
    }
