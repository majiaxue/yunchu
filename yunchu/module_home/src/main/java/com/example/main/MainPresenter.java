...
public class MainPresenter extends BasePresenter<MainView> {
    ...
    private static final String savePath = "/sdcard/qdsc/apk"; // apk保存到SD卡的路径
    private static final String saveFileName = savePath + "/qdsc"; // 完整路径名

    private static final String patchPath = "/sdcard/qdsc/patch"; // apk保存到SD卡的路径
...
//                    Beta.applyDownloadedPatch();
    ...
    public void installAPK() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(mContext, "com.qdsc.taobaoke.provider", apkFile);
