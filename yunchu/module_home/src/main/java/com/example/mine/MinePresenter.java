...
//                ProcessDialogUtil.dismissDialog();
                ...
                File file = new File(Environment.getExternalStorageDirectory().getPath() + "/jjyp/image/" + "jjypHead.jpg");
                if (file.exists()) {
...
//                }
    ...
    private void downPic(String url) {
        ...
        File file = new File(Environment.getExternalStorageDirectory() + "/jjyp/image");
        if (file.exists()) {
            file.mkdirs();
        }
        File file1 = new File(Environment.getExternalStorageDirectory() + "/jjyp/image/" + "jjypHead.jpg");
        try {
            //文件输出流
